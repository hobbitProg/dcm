...
/**
  * Specification for trying to add a book with the same title and author of a
  * book that already exists in the book catalog
  * @author Kyle Cranmer
  * @since 0.2
  */
class AddingBookWithSameTitleAndAuthorSpec
    extends PropSpec
