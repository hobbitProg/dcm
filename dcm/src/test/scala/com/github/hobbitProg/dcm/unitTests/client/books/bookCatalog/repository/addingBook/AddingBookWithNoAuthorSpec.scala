...
/**
  * Specification for trying to add a book with no author to a book repository
  * @author Kyle Cranmer
  * @since 0.2
  */
class AddingBookWithNoAuthorSpec
    extends PropSpec
  ...
  property("indicates the repository was not updated") {
    forAll(databaseGenerator, repositoryGenerator, noAuthorDataGenerator) {
