...
lazy val root = (project in file(".")).
  settings(
    ...
    libraryDependencies += "org.specs2" %% "specs2-core" % "4.0.2-291bdf5-20171123131811" % Test,
    libraryDependencies += "org.specs2" %% "specs2-scalacheck" % "4.0.2-291bdf5-20171123131811" % Test,
